          ...
          <div>
              <div className="flex flex-col items-center justify-center p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <div className="w-screen px-12">
                          <input type="email" name="email" id="email" onChange={handleChange} value={fields.email} className="bg-white border border-black rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 text-black placeholder-black font-medium" placeholder="Nombre" required=""/>
                      </div>
                      <div className="w-screen px-12">
